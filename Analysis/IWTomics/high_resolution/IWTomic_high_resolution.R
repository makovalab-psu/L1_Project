...
## import files with datasets and features (not shown here)
...
# load IWTomics data object data and select only autosomes
...
#IWTomics test on median, variance and quantiles (not shown in the current study)
...
##########################################################
#### Create subsamples for de novo and control sets   ####
##########################################################
# setwd("~/Google_Drive/L1_Project/Analysis/IWTomics/high_resolution/")
