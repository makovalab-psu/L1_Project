...
write.table(shift_sum,file = "~/Google_Drive/L1_Project/Analysis/sFLR/shift_table.txt",sep="\t",quote=FALSE)
...
for (r in 1:10){
  ...
  #load('L1_low_resolution_autosomes.RData')
  file=paste('~/Google_Drive/L1_Project/Analysis/IWTomics/high_resolution/L1_autosomes_results_smoothed_mean_', r, '.RData', sep="")
  load(file)
