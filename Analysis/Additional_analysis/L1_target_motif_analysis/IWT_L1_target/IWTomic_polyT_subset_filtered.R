####################################################################################
### IWTomics analysis of L1 target motifs using stringently filtered de novo L1s ### 
####################################################################################

require(IWTomics)
require(dendextend)

setwd("~/Google_Drive/L1_Project/Analysis/Additional_analysis/L1_target_motif_analysis/IWT_L1_target/")
...
features_datasets=features_datasets[1,]

##The following section is commented to avoid large intermediate files##

# Read data and save dRata
...
pdf('IWT_autosomes_smoothed_mean_filtered.pdf',width=7,height=10)
